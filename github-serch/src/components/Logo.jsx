...
const Logo = () => {
  ...
  return (
    <div className='my-3 mx-2'>
      ...
      <div className='flex flex-row justify-center items-center mt-4 border-[1px] px-3 py-2 border-gray-400 rounded cursor-pointer' onClick={()=>(theme=='light' ? setTheme('dark'):setTheme('light'))}>
